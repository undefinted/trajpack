...
| Is DeepSeek Harness a real first-class path? | Installable rc.6 plugin, typed `session/event`, route/header reconciliation, exact two-epoch fixture, bounded plugin queue, flush/dispose failure propagation. | Validated against pinned rc.6 types and fixtures; live upstream remains Developer Preview |
